        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UniversityService = /** @class */ (function () {
                function UniversityService(http) {
                    this.http = http;
                    this.collegeUrl = '../schoolControl.ctl'; // 自己机器上的servlet
                    this.depUrl = '../departmentControl.ctl';
                    this.titleUrl = '../titleControl.ctl';
                    this.teacherUrl = '../teacherControl.ctl';
                    this.degreeUrl = '../degreeControl.ctl';
                }
